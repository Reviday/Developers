	      ...
	      <div class="">
			    ...
			    <div class="row">
			    	<div class="form-group col-md-6">
					   ...
					   <div>
					      <input type="text" class="form-control" name="busCountry" placeholder="한국" value="한국" readonly required>
					   </div>
					</div>
					<div class="form-group col-md-6">
						<div class="subtitles">
			    ...
			    <div class="row">
			    	<div class="form-group col-md-6">
					   ...
					   <div>
					      <input type="text" class="form-control" name="busRegNo" placeholder="'-'제외 10자" required>
					   </div>
					 </div>
			    	<div class="form-group col-md-6"> 
					   <div class="subtitles">
					   ...
					   <div>
					      <input type="text" class="form-control" name="busIncome" placeholder="매출액/투자금액 입력 (단위 : 억원)" required>
					   </div>
					 </div> 
			     </div>
	 			     			     <br>
			    ...
			    <div class="row">
					 ...
					 <div class="form-group col-md-6">  
					   ...
					   <div>
					   	  <select class="form-control" name="busTotalEmp"><option value="">회사규모</option><option value="1~4">1~4명</option><option value="5~10">5~10명</option><option value="11~50">11~50명</option><option value="51~200">51~200명</option><option value="201~500">201~500명</option><option value="501~1000">501~1000명</option><option value="1001~5000">1001~5000명</option><option value="5001~10000">5001~10000명</option><option value="10001~">10000명 이상</option></select>
			    ...
			    <div>
				   ...
				   <div>
				      <textarea class="form-control" name="busIntroduce" placeholder="회사 정보 입력" rows="60"></textarea>
			    ...
			    <div class="row">
					...
					<div class="form-group col-md-6">						   
						   ...
						   <div>
						      <input type="text" class="form-control" name="busEmail" placeholder="기존에 적었던 이메일 primary key 불러오기" required>
						   </div>
					</div>	   
			     </div>
			     			     			     <br>
			    <div class="row">
			    	<div class="form-group col-md-6">
						   ...
						   <div>
						      <input type="text" class="form-control" name="busPhone" placeholder="기존에 적었던 전화번호 불러오기" required>
						   </div>
					</div>	   
					<div class="form-group col-md-6">	   
			    ...
			    <div>
				   ...
				   <div>
				      <input type="text" class="form-control" name="searchKeywords" placeholder="서비스 명 혹은 브랜드 명 입력" >
				   </div>
			     </div>
			     			     			     <br>
			    <div>
