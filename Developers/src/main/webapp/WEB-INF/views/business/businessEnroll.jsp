 ...
 <br>
 	<form action="${pageContext.request.contextPath}/business/businessEnroll.do" method="post">
	      <div class="modal-body">
			    ...
			    <br/>
			    직원수(승인기준 팀원 10명 이상) *<input type="text" class="form-control" name="busTotalEmp" placeholder="서울" required>
			    <br/>
			    ...
			    <br/>
			    정보 수신 이메일 *<input type="text" class="form-control" name="busEmail" placeholder="기존에 적었던 이메일 primary key 불러오기" required>
			    <br/>
			    담당자 연락처 *<input type="text" class="form-control" name="busPhone" placeholder="기존에 적었던 전화번호 불러오기" required>
			    <br/>
