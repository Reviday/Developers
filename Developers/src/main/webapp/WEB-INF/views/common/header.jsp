      ...
      <div class="header_nav container">
         <nav>
            ...
            <ul class="nav_items">
               ...
               <li class="microMoreVisible"><a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0" class="">직군별 연봉</a></li>
                  ...
                  <div class="xsMenuBar" style="display:none">
                     ...
                     <ul>
                        ...
                        <li class="hideForAnonymous"><a href="/status/applications"
                           class="">지원 현황</a></li>
                        <div class="divider xsOnly"></div>
                        <li class="microOnly"><a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0" class="">직군별 연봉</a></li>
               ...
               <aside class="aside_menu">
                  ...
                  <div class="xsMenuBar" style="display:none">
                     ...
                     <ul>
                        ...
                        <div class="divider xsOnly"></div>
                        <li class="microOnly">
                           <a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0" class="">직군별 연봉</a>
                        </li>
                        <li class="xsOnly">
