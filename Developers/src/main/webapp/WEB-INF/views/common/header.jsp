      ...
      <div class="header_nav container">
         <nav>
            ...
            <ul class="nav_items">
               ...
               <c:if test="${empty loginMember }">
               <li class=""><a href="${path }/search/mainSearch.do" class="">직무 탐색</a></li>
               </c:if>
               <c:if test="${not empty loginMember }">
               <li class=""><a href="${path }/search/mainSearch.lmc?memNo=${loginMember.memNo}" class="">직무 탐색</a></li>
               </c:if>
               <li class="microMoreVisible"><a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0&job_type=전체&salarySearch=0" class="">연봉 탐색</a></li>
                  ...
                  <div class="xsMenuBar" style="display:none">
                     ...
                     <ul>
                        ...
                        <li class="hideForAnonymous"><a href="/status/applications"
                           class="">지원 현황</a></li>
                        <div class="divider xsOnly"></div>
                        <li class="microOnly"><a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0&job_type=전체&salarySearch=0" class="">연봉 탐색</a></li>
               ...
               <aside class="aside_menu">
                  ...
                  <div class="xsMenuBar" style="display:none">
                     ...
                     <ul>
                        ...
                        <div class="divider xsOnly"></div>
                        <li class="microOnly">
                           <a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0&job_type=전체&salarySearch=0" class="">연봉 탐색</a>
                        </li>
                        <li class="xsOnly">
