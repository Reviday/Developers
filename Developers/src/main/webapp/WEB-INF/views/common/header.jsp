      ...
      <div class="header_nav container">
         <nav>
            ...
            <ul class="nav_items">
               ...
               <li class="microMoreVisible"><a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0&jobName1=전체&salarySearch=0" class="">연봉 탐색</a></li>
                  ...
                  <div class="xsMenuBar" style="display:none">
                     ...
                     <ul>
                        ...
                        <li class="hideForAnonymous"><a href="/status/applications"
                           class="">지원 현황</a></li>
                        <div class="divider xsOnly"></div>
                        <li class="microOnly"><a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0&jobName1=전체&salarySearch=0" class="">연봉 탐색</a></li>
               ...
               <aside class="aside_menu">
                  ...
                  <div class="xsMenuBar" style="display:none">
                     ...
                     <ul>
                        ...
                        <div class="divider xsOnly"></div>
                        <li class="microOnly">
                           <a href="${path }/salary/salaryYears.do?jobField=f0&jobYears=0&jobName1=전체&salarySearch=0" class="">연봉 탐색</a>
                        </li>
                        <li class="xsOnly">
